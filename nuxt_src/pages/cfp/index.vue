...
en:
  ...
  section2_1: |
    For ScalaMatsuri 2020, the speakers will be determined using 2 methods:<br>
  ...
  section2_2: |
    Voting by participants:
      We will conduct a ballot by ScalaMatsuri participants.<br/>
      Talks will be selected based on the number of votes.<br/>
      During the selection we might also consider the buzz on social networks such as Twitter and Facebook into account.<br/>
    <br/>
  ...
  section3_button: <a href="https://forms.gle/9YXwoKXTPCoF1LS69">Submit my talk</a> / <a href="https://forms.gle/3PSAEUeB2nTFTrKK7">Add another speaker</a>
...
ja:
  ...
  section1_2: |
    ...
    性別や人種など、多様な背景を持つ人々が互いに敬意を払って楽しい時間を過ごせるよう、当カンファレンスでは、<br/>
    発表者や参加者、スポンサーの皆さんに<a href="%{coc_link}" target="_blank" rel="noopener"><span>行動規範</span></a>を守っていただくようにお願いしています。<br/>
    アジア最大規模の国際的なイベントとして、日本からの参加者にも海外からの参加者も楽しめるイベントにしたいと思っています。<br/>
  ...
  section2_1: |
    ...
    <ul class="section_note">
      ...
      <li class="section_note_item"> 選考委員による推薦 </li>
    </ul>
    の2通りの方法で講演者が決定されます。 <br/>
  section2_2: |
    参加者による投票:
      ScalaMatsuri参加者による投票を実施します。<br/>
      その得票数から、皆さんが特に聞きたいと思っている講演を選びます。<br/>
      その際、TwitterやFacebookなどのSNSでの拡散度合いも参考にする場合があります。<br/>
    <br/>
    選考委員による推薦:
      Scala エコシステムやトレンドに詳しい人のセンスで選ぶ枠です。<br/>
      先進的なセッションや基礎を深く解説するセッション、<br/>
      Scalaを学びはじめた人にぜひ聞いてほしいセッションなど、<br/>
      皆さんが楽しめるであろうセッションを幅広く選出します。
  section3_title: "応募"
  section3_button: <a href="https://forms.gle/6nwjzQ7N7ZPFvB5m8">セッション応募フォーム</a>  / <a href="https://forms.gle/3PSAEUeB2nTFTrKK7">追加講演者登録フォーム</a>
  section4_title: "応募要項"
  section4_1: |
    <ul class="section_note">
      <li class="section_note_item">内容は、Scala ビギナー もしくは Scala コミュニティが興味があると思うトピックであれば自由です。</li>
      <li class="section_note_item">講演の時間は、40分 と 100分（うち20分は休憩)の２種類あります。</li>
      ...
      <li class="section_note_item">提出には、日本語で200字以内の概要、および300字以内の英語の概要が必要です。(採択後に、あらためて長めの概要の提出をお願いする場合があります。)</li>
      <li class="section_note_item">投票者が講演内容のイメージを掴むための手助けとして、キーワードを3つまで登録いただけます。このキーワードはセッション候補一覧のページに表示されます。</li>
      <li class="section_note_item">1人３セッションまで応募していただけます。ただし、投票枠、選考委員枠で複数選ばれた場合は、どれか一つを選択していただきます。</li>
      <li class="section_note_item">各種制限を超えている場合など、運営の判断で掲載内容を若干修正する場合があります。予めご了承ください。</li>
      <li class="section_note_item">セッション内容の掲載後修正がある場合は、<a href="https://github.com/ScalaMatsuri/2020.scalamatsuri.org" target="_blank" rel="noopener">こちらのRepositoryへ直接Pull Request</a>をお送りください。</li>
    </ul>
  section4_2: |
    概要、スライド等の英語につきましては、運営のベストエフォートでレビューをしています。
  section5_title: "旅費助成金"
  section5_1: |
    ScalaMatsuri は、日本各地、そして世界の多様なスピーカーからセッションを募集しています。<br>
    遠方へと移動しなくてはいけない障壁を取り払うために、希望する投票上位のスピーカーに旅費助成金を用意しています。
  section5_2: |
    ScalaMatsuri は、非営利の法人である Japan Scala Association によって運営されているため、 旅費助成金は我々が経費として取り扱えるものに限定されることをご了承ください。<br/>
  ...
  section5_5: |
    経費の申請は ScalaMatsuri 終了後の一ヶ月間のみ行うことができます。<br/>
    全ての申請費用に関して航空会社からのメールの転送、もしくは領収書のスキャン/写真を必要とします。<br>
    ScalaMatsuri の事前に旅費助成金を希望する場合は、その旨ご連絡ください。
  section5_6: |
    旅費助成金の最高額は出発地によって決まっています
  section5_7: |
    <ul class="section_note">
      <li class="section_note_item">社会人 国内 500ドル 国外 1000ドル</li>
      <li class="section_note_item">学生 国内 750ドル 国外 1500ドル</li>
    </ul>
  section5_8: |
    旅費助成金として支給する額は、実際の経費申請額を超えることはありません。<br/>
    例えばあなたが旅費助成金を承認されたとして、ヨーロッパから出発して旅費が $1500 かかった場合には、ScalaMatsuri が後日払い戻すのは $1000 までです。<br/>
    アジアから出発して旅費が $700 かかった場合には、払い戻すのは $700 です。<br/>
    また、学生の方は、最高額をそれぞれ国内 750ドル 国外 1500ドルにまで増額いたします。<br/>
    学生の方は応募時に所属に学年をご記入ください (例、博士課程4年目の場合 D4 など)。
  section5_9: |
    万が一、カンファレンスに出席できない場合は旅費助成金の経費は受理されませんので、ご注意ください。<br/>
    ただし、天災、講演者やご家族の死亡、病気の場合 ScalaMatsuri 実行委員会の裁量で、旅費の一部を受理する可能性があります。<br/>
  ...
  <div id="cfp">
    ...
    <div class="section">
      <p class="section_text">
        <span v-html="$t('section1_1')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section1_2', { coc_link: localePath('code-of-conduct') })" />
      </p>
    </div>
    <div class="section">
      ...
      <p class="section_text">
        <span v-html="$t('section2_1')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section2_2')" />
      </p>
    </div>
    <div class="section">
      <h2 class="section_title">
    ...
    <div class="section">
      ...
      <p class="section_text">
        <span v-html="$t('section4_1')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section4_2')" />
      </p>
    </div>
    <div class="section">
      <h2 class="section_title">
      ...
      <!-- これforとかでやったほうが良い？-->
      <p class="section_text">
        <span v-html="$t('section5_1')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_2')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_3')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_4')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_5')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_6')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_7')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_8')" />
      </p>
      <p class="section_text">
        <span v-html="$t('section5_9')" />
      </p>
    </div>
  </div>
</template>
...
export default {
  head() {
    return {
      ...
      meta: [{ name: 'og:title', content: 'ScalaMatsuriに応募する | ScalaMatsuri 2020' }]
    }
  }
}
</script>
