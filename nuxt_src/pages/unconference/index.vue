...
en:
  ...
  themes_text_01: |
    ...
    <br><br>
    Here are all unconference idea samples.
  themes_text_02: |
  ...
  themes_text_03: |
    ...
    <br><br>
    Also, this unconference can be a wide variety of themes, such as themes that were not accepted,  your hobby projects, even or your lifestyle / career as a Scala engineer.
    <br><br>
...
<template>
  <div id="unconference">
    ...
    <div class="section">
      <h2 class="section_title">
        <span class="section_title_inner">{{ $t('unconference_flow_title') }}</span>
      </h2>
      <p class="section_text" v-html="$t('unconference_flow_text_01')" />
    </div>
    <div class="section">
      <h2 class="section_title">
